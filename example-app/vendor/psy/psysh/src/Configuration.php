...
class Configuration
{
     ...
     * be searched, and the first `config.old.php` or `rc.php` file which exists
     * will be returned.
     *
     * If you're trying to decide where to put your config file, pick
     *
     *     ~/.config/psysh/config.old.php
     *
     * @return string|null
     */
    public function getConfigFile()
    {
        ...
        $files = $this->configPaths->configFiles(['config.old.php', 'rc.php']);
    ...
    /**
     * Load a configuration file (default: `$HOME/.config/psysh/config.old.php`).
     *
